    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center px-6 py-12">
      <div className="max-w-xl w-full bg-white border border-slate-200 rounded-[2rem] p-12 shadow-2xl shadow-slate-200/50">
        ...
        <p className="text-center mt-8">
          <Link to="/admin/login" className="text-[10px] font-black text-slate-400 hover:text-slate-900 uppercase tracking-[0.2em] transition-colors">Already registered? Sign In</Link>
        </p>
      </div>
    </div>
  );
